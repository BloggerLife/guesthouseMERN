  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="Dashboard"
        subTitle="Monitor your house listings, track bookings and analyze revenue—all in one place. Stay updated with real-time insights to ensure smooth operations."
      />
