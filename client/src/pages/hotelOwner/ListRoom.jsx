  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="BnB Listings"
        subTitle="View, edit, or manage all listed BnBs. Keep the information up-to-date to provide the best experience for users."
      />
      <p className="text-gray-500 mt-8">Total BnBs</p>
